...
#' The first one plots the \code{object$BTErrors$training.error} (in black) as well as the \code{object$BTErrors$validation.error} and/or the \code{object$BTErrors$cv.error} depending on the \code{method} and
